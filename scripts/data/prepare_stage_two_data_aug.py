...
Our experiments also show this augmentation strategy is more effective than using pure hard questions or a mixture of hard and easy questions.

Usage:
    python prepare_stage_two_data_aug.py --local_dir ./data --aug_version all
"""
